...
def visualize_aggregated_orderbook(token: str):
    ...
    st.write(pd.concat([
        ...
        axis=1)[['exchange_bid', 'order_amount_bid', 'quantity_bid', 'price_bid', 'price_ask', 'quantity_ask',
                 'order_amount_ask', 'exchange_ask']])
...
if __name__ == '__main__':
    ...
    common_tokens = list(
        set(bybit_currencies['tokenName'].unique().tolist()) & set(gateio_currencies['currency'].unique().tolist()))
